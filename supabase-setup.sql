...
-- Create document_text_search table
...
-- Create pdf_processing_jobs table
...
CREATE INDEX IF NOT EXISTS "share_links_documentId_idx" ON "share_links"("documentId");
CREATE INDEX IF NOT EXISTS "share_links_creatorId_idx" ON "share_links"("creatorId");
CREATE INDEX IF NOT EXISTS "view_audits_documentId_idx" ON "view_audits"("documentId");
CREATE INDEX IF NOT EXISTS "view_audits_userId_idx" ON "view_audits"("userId");
CREATE INDEX IF NOT EXISTS "document_access_documentId_idx" ON "document_access"("documentId");
CREATE INDEX IF NOT EXISTS "document_access_userId_idx" ON "document_access"("userId");
CREATE INDEX IF NOT EXISTS "page_access_documentId_idx" ON "page_access"("documentId");
CREATE INDEX IF NOT EXISTS "page_access_userId_idx" ON "page_access"("userId");
